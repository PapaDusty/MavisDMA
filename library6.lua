...
local ICON_ASSET = "rbxassetid://75466683081922"

local function LexendFont(weight)
	local ok, font = pcall(function()
		return Font.new("rbxasset://fonts/families/Lexend.json", weight, Enum.FontStyle.Normal)
	end)
	if ok then
		return font
	end
...
local Theme = {
	...
	Font = LexendFont(Enum.FontWeight.Regular),
	FontMedium = LexendFont(Enum.FontWeight.Medium),
	FontSemibold = LexendFont(Enum.FontWeight.SemiBold),
	FontBold = LexendFont(Enum.FontWeight.Bold),
}
...
local function IconPlaceholder(parent, size, color)
...
function Library:CreateWindow(config)
	...
	local Main = New("Frame", {
		Name = "Main",
		Size = UDim2.new(0, 950, 0, 610),
		Position = UDim2.new(0.5, -475, 0.5, -305),
	...
	local searchIcon = IconPlaceholder(SearchBox, 14)
	...
	local GearButton = New("TextButton", {
		...
		Position = UDim2.new(0, 254, 0.5, -17),
		BackgroundColor3 = Theme.Element,
		Text = "",
	...
	local gearIcon = IconPlaceholder(GearButton, 16)
	...
	local Content = New("Frame", {
		Name = "Content",
		Size = UDim2.new(1, -211, 1, -56),
		Position = UDim2.new(0, 211, 0, 56),
		BackgroundTransparency = 1,
	...
	local sidebarDivider = Main:FindFirstChild("SidebarDivider")
...
function Library:AddTab(config)
	...
	local navIcon = IconPlaceholder(NavButton, 16)
