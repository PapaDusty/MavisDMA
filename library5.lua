...
local function IconPlaceholder(parent, size, isCircle)
	...
	Round(icon, isCircle and size or 4)
	return icon
end
...
function Library:CreateWindow(config)
	...
	Round(SearchBox, 8)
	local searchIcon = IconPlaceholder(SearchBox, 14, true)
	...
	Round(GearButton, 8)
	local gearIcon = IconPlaceholder(GearButton, 16, true)
...
function Library:AddTab(config)
	...
	local navIcon = IconPlaceholder(NavButton, 16, false)
...
function TabMethods:AddSection(config)
	...
	New("UIPadding", { PaddingTop = UDim.new(0, 6), Parent = RowHolder })
